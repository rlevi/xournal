...
create_winMain (void)
{
  ...
  HildonColorButton *menu_tool_button_color;
  GtkWidget *hildon_toolbar;
  GtkWidget *menu_tool_button_zoom;
  GtkToolItem *colorItem;
  GtkToolItem *buttonPen;
  GtkToolItem *buttonEraser;
  GtkToolItem *buttonHighlighter;
  GtkToolItem *buttonUndo;
  GtkToolItem *buttonRedo;
  GtkToolItem *buttonText;
  GtkToolItem *buttonRuler;
  GtkToolItem *buttonPressure;
  GtkToolItem *toolbarSeparator;
  GtkToolItem *buttonFirstPage;
  GtkToolItem *buttonPreviousPage;
  GtkToolItem *buttonNextPage;
  GtkToolItem *buttonLastPage;
  GtkToolItem *buttonZoomOut;
  GtkToolItem *buttonZoomIn;
  GtkToolItem *buttonNormalSize;
  GtkToolItem *newButton;
  GtkToolItem *saveButton;
  GtkToolItem *openButton;
  GtkWidget *xournalHelp;
  GtkWidget *vbox;
#else
  GtkWidget *winMain;
  GtkWidget *buttonPen;
  ...
  winMain = GTK_WIDGET(hildon_window);
  ...
  hildon_program_set_common_menu (hildon_program, GTK_MENU (menubar));
#else
...
#ifdef USE_HILDON
  fileQuit = gtk_menu_item_new_with_mnemonic (_("_Close"));
#else
...
#ifdef USE_HILDON
  xournalHelp = gtk_menu_item_new_with_mnemonic (_("H_elp..."));
  gtk_container_add (GTK_CONTAINER (menubar), xournalHelp);
  helpAbout = gtk_menu_item_new_with_mnemonic (_("_About..."));
  gtk_container_add (GTK_CONTAINER (menubar), helpAbout);
  gtk_container_add (GTK_CONTAINER (menubar), fileQuit);
  gtk_widget_show (xournalHelp);
  gtk_widget_show (helpAbout);
  gtk_widget_show (fileQuit);
  gtk_widget_set_sensitive (filePrint, FALSE);
  
  /* Create Hildon Toolbar */
  hildon_toolbar = gtk_toolbar_new ();

  tmp_image = create_pixmap (GTK_WIDGET (hildon_window), "draw-freehand.png");
  buttonPen = gtk_radio_tool_button_new (NULL);
  gtk_tool_button_set_icon_widget (GTK_TOOL_BUTTON(buttonPen), tmp_image);

  tmp_image = create_pixmap (GTK_WIDGET (hildon_window), "draw-eraser.png");
  buttonEraser = gtk_radio_tool_button_new (NULL);
  gtk_tool_button_set_icon_widget (GTK_TOOL_BUTTON(buttonEraser), tmp_image);

  tmp_image = create_pixmap (GTK_WIDGET (hildon_window), "highlighter.png");
  buttonHighlighter = gtk_radio_tool_button_new (NULL);
  gtk_tool_button_set_icon_widget (GTK_TOOL_BUTTON(buttonHighlighter), tmp_image);

  tmp_image = create_pixmap (GTK_WIDGET (hildon_window), "draw-text.png");
  buttonText = gtk_radio_tool_button_new (NULL);
  gtk_tool_button_set_icon_widget (GTK_TOOL_BUTTON(buttonText), tmp_image);
  
  tmp_image = create_pixmap (GTK_WIDGET (hildon_window), "ruler.png");
  buttonRuler = gtk_toggle_tool_button_new ();
  gtk_tool_button_set_icon_widget (GTK_TOOL_BUTTON(buttonRuler), tmp_image);
  
  tmp_image = create_pixmap (GTK_WIDGET (hildon_window), "draw-ink.png");
  buttonPressure = gtk_toggle_tool_button_new ();
  gtk_tool_button_set_icon_widget (GTK_TOOL_BUTTON(buttonPressure), tmp_image);
...
//  gtk_radio_tool_button_set_group (GTK_RADIO_TOOL_BUTTON (buttonRuler), buttonPen_group);
//  buttonPen_group = gtk_radio_tool_button_get_group (GTK_RADIO_TOOL_BUTTON (buttonRuler));
  ...
  buttonUndo =  gtk_tool_button_new_from_stock (GTK_STOCK_UNDO);
  buttonRedo =  gtk_tool_button_new_from_stock (GTK_STOCK_REDO);
  buttonFirstPage =  gtk_tool_button_new_from_stock (GTK_STOCK_GOTO_FIRST);
  buttonPreviousPage = gtk_tool_button_new_from_stock (GTK_STOCK_GO_BACK);
  buttonNextPage = gtk_tool_button_new_from_stock (GTK_STOCK_GO_FORWARD);
  buttonLastPage =  gtk_tool_button_new_from_stock (GTK_STOCK_GOTO_LAST);
  buttonZoomOut = gtk_tool_button_new_from_stock (GTK_STOCK_ZOOM_OUT);
  buttonZoomIn = gtk_tool_button_new_from_stock (GTK_STOCK_ZOOM_IN);
  buttonNormalSize = gtk_tool_button_new_from_stock (GTK_STOCK_ZOOM_100);
  ...
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonText, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonPen, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonEraser, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonHighlighter, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonRuler, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonPressure, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), toolbarSeparator, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), colorItem, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonUndo, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonRedo, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonFirstPage, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonPreviousPage, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonNextPage, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonLastPage, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonZoomOut, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonNormalSize, -1);
  gtk_toolbar_insert (GTK_TOOLBAR (hildon_toolbar), buttonZoomIn, -1);

  hildon_program_set_common_toolbar (hildon_program, GTK_TOOLBAR (hildon_toolbar));
  hildon_window_add_toolbar (hildon_window, GTK_TOOLBAR (hildon_toolbar));
  ...
  g_signal_connect (G_OBJECT(buttonColor), "clicked",
		    G_CALLBACK (on_colorButton_activate),
		    NULL);
  ...
  g_signal_connect ((gpointer) buttonRuler, "toggled",
                    G_CALLBACK (on_toolsRuler_activate),
                    NULL);
  g_signal_connect ((gpointer) buttonPressure, "toggled",
		    G_CALLBACK (on_optionsPressureSensitive_activate),
		    NULL);
...
#ifdef USE_HILDON
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonPen), "buttonPen");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonEraser), "buttonEraser");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonHighlighter), "buttonHighlighter");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonText), "buttonText");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonRuler), "buttonRuler");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonPressure), "buttonPressure");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(toolbarSeparator), "toolbarSeparator");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(saveButton), "saveButton");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(newButton), "newButton");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(openButton), "openButton");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonUndo), "buttonUndo");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonRedo), "buttonRedo");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonFirstPage), "buttonFirstPage");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonPreviousPage), "buttonPreviousPage");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonNextPage), "buttonNextPage");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonLastPage), "buttonLastPage");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonZoomOut), "buttonZoomOut");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonNormalSize), "buttonNormalSize");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonZoomIn), "buttonZoomIn");
  GLADE_HOOKUP_OBJECT (winMain, GTK_WIDGET(buttonColor), "buttonColor");
#else
...
#ifdef USE_HILDON
  GLADE_HOOKUP_OBJECT (winMain, xournalHelp, "xournalHelp");
#endif
