...
void
hildon_tools_other_action		(GtkAction *action);

void
on_HildonHelp_activate			(GtkWidget *widget,
					 gchar *help_id);

void
on_HildonShowLayer_activate		(GtkWidget *widget,
					 gpointer data);

void
osso_mime_callback                      (gpointer data,
                                         int argc,
                                         gchar **argv);

void
on_colorButton_activate                 (GtkWidget *widget,
					 gpointer data);

void
on_exitDbus_handler			(gboolean die_now,
					 gpointer data);

void
on_hardwareEvent_handler		(osso_hw_state_t *state,
					 gpointer data);
